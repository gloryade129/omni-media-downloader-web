...
export const defaultPlatforms: CarouselItem[] = [
  {
    tag: "#YouTube",
    titleLine1: "YOUTUBE HD & MP3",
    titleLine2: "– 4K & PLAYLISTS",
    desc: "Download videos in 1080p/4K or extract high quality 320kbps MP3 audio",
    img: "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=800&auto=format&fit=crop&q=80",
    ctaText: "Select YouTube",
    ctaUrl: "#downloader",
    platformKey: "youtube",
  },
  {
    tag: "#TikTok",
    titleLine1: "TIKTOK NO WATERMARK",
    titleLine2: "– HD REELS & AUDIO",
    desc: "Clean TikTok video downloads without watermark and instant MP3 sound extraction",
    img: "https://images.unsplash.com/photo-1598899134739-24c46f58b8c0?w=800&auto=format&fit=crop&q=80",
    ctaText: "Select TikTok",
    ctaUrl: "#downloader",
    platformKey: "tiktok",
  },
  {
    tag: "#Instagram",
    titleLine1: "INSTAGRAM REELS",
    titleLine2: "– POSTS & IGTV",
    desc: "Save high definition Instagram Reels, Stories, Carousels and audio clips instantly",
    img: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=800&auto=format&fit=crop&q=80",
    ctaText: "Select Instagram",
    ctaUrl: "#downloader",
    platformKey: "instagram",
  },
  {
    tag: "#Facebook",
    titleLine1: "FACEBOOK VIDEOS",
    titleLine2: "– WATCH & REELS",
    desc: "Download public Facebook video streams in 1080p HD quality",
    img: "https://images.unsplash.com/photo-1563986768609-322da13575f3?w=800&auto=format&fit=crop&q=80",
    ctaText: "Select Facebook",
    ctaUrl: "#downloader",
    platformKey: "facebook",
  },
  {
    tag: "#TwitterX",
    titleLine1: "TWITTER / X MEDIA",
    titleLine2: "– CLIPS & GIFS",
    desc: "Extract HD video clips and high resolution media posts from Twitter / X",
    img: "https://images.unsplash.com/photo-1611605697805-88c4b6932400?w=800&auto=format&fit=crop&q=80",
    ctaText: "Select Twitter / X",
    ctaUrl: "#downloader",
    platformKey: "twitter",
  },
];
...
export function CoverFlowCarousel({
  ...
  return (
    <section
      className={`relative w-full min-h-[720px] flex items-center justify-center overflow-hidden py-8 select-none ${className}`}
      style={{
    ...
    >
      ...
      <div className="relative w-full max-w-6xl mx-auto px-4 z-10 flex flex-col items-center">
        ...
        {/* 3D Coverflow Stage */}
        <div
          className="relative w-full h-[480px] flex justify-center items-center mb-8"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span>{item.ctaText || "Download"}</span>
                      <ArrowRightIcon />
                    </a>
                  </div>
                </div>
